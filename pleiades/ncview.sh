...
build_hdf5() {
    ...
    cd hdf5-$ver
    CC=mpiicc CFLAGS="-ipo -axCORE-AVX2 -xSSE4.2" ./configure --enable-parallel --prefix=$LOCAL_LIB_DIR
...
build_nco() {
    ...
    CC=mpiicc CFLAGS="-ipo -axCORE-AVX2 -xSSE4.2" CPPFLAGS="-I$LOCAL_LIB_DIR/include -I/nasa/nco/4.4.6/include" LDFLAGS="-L$LOCAL_LIB_DIR/lib -L/nasa/nco/4.4.6/lib" ./configure \
